...
if __name__ == "__main__":
    ...
    with mlflow.start_run():
        ...
        print("Gradient Boosting Regressor model (criterion=%f, learning_rate=%f, max_leaf_nodes=%f, n_estimators=%f):" % (criterion, learning_rate, max_leaf_nodes, n_estimators))
        print("  RMSE: %s" % rmse)
        print("  MAE: %s" % mae)
        print("  R2: %s" % r2)
